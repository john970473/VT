...
$(function () {
	...
	for(let i=0; i<6; i++){
		...
		html += "<div><a href=\"https://john970473.github.io/VT/"+video_url[i]+"/\"><img src=\"http://img.youtube.com/vi/"+video_url[i]+"/sddefault.jpg\"></a></div>";
		html += "<div><a href=\"https://john970473.github.io/VT/"+video_url[i]+"\" title=\"title\">"+video_title[i]+"</a></div>";
